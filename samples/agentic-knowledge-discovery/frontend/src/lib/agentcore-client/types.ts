...
/** Identifier of the deployed agent implementation (e.g. "strands-agent",
 * "langgraph-agent"). Both speak AG-UI, so this is informational only. */
export type AgentPattern = string
