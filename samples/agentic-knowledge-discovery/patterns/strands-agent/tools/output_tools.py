...
"""Strands output tools: follow-up suggestions and source citations.

These are lightweight in-runtime tools (no external I/O) that structure output
the frontend renders: suggested_questions as clickable chips, citations as
source badges. They mirror the DISKOS agent's suggest_questions / cite_sources.
"""
