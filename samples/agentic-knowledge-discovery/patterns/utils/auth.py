...
def get_gateway_access_token(user_id: str) -> str:
    ...
    These claims are an extension point for an authorization layer at the Gateway;
    this sample propagates them but does not enforce any policy (authentication only).
