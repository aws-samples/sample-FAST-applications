  ...
  return (
    <>
      <div className="section-head">
        ...
        <p>
          Memory is scoped to the corporate customer rather than the analyst, so any reviewer sees
          the same history. On a re-assessment the agent recalls what the bank concluded last time
      ...
      <div className="panel" style={{ marginBottom: 20 }}>
        <div className="panel-body">
          <div style={{ display: "flex", gap: 8, alignItems: "flex-end" }}>
            ...
            <button className="btn btn-ghost" onClick={() => void load(customerId)} disabled={busy}>
              Refresh
            </button>
          </div>
        ...
        <div className="grid-2" style={{ gridTemplateColumns: "1fr 1fr" }}>
          <div className="panel">
            <div className="panel-head">
              <span className="panel-title">Short-term memory — assessment timeline</span>
            </div>
            <div className="panel-body">
                  ...
                  return (
                    <div className="tl-item" key={event.eventId ?? index}>
                      <div className="tl-time">
                        {formatTime(event.eventTimestamp)} · {event.sessionId?.slice(0, 18)}
                      </div>
          ...
          <div className="panel">
            <div className="panel-head">
              <span className="panel-title">Long-term memory — extracted records</span>
            </div>
            <div className="panel-body">
              {view.records.length === 0 ? (
                <div className="muted">
                  No records extracted yet. The semantic and summary strategies run asynchronously
                  after an assessment — records typically appear within a few minutes, and are what
                  the agent retrieves on the next review.
                </div>
              ) : (
                <div className="stack">
