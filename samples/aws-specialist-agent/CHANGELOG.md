...
- Updated repository references for open source release
- Generalized environment-specific references to neutral paths
...
- Renamed the project to "Fullstack AgentCore Solution Template (FAST)"
