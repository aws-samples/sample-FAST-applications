...
1. Always read READMEs when you begin working in a new section of the code base before writing any code. For example frontend/README.md, infra-cdk/README.md, agent/strands-single-agent/README.md, and so on.
