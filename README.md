...
| [Meridian Risk](#meridian-risk) | Governed multi-agent Know-Your-Customer onboarding — one Gateway fronts both tools (MCP) and models (inference), enforced by Cedar Policy, with a managed Harness, Guardrails, and OpenTelemetry observability |
